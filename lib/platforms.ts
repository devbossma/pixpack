...
export const PLATFORM_SPECS: Record<Platform, PlatformSpecWithIcon> = {
  instagram_post:  { id: 'instagram_post',  name: 'Instagram Post',  icon: '📸', LucideIcon: Instagram,    width: 1080, height: 1080, aspectRatio: '1:1'   },
  ...
  shopify_product: { id: 'shopify_product', name: 'Shopify Product', icon: '🛍️', LucideIcon: ShoppingBag,  width: 800,  height: 800,  aspectRatio: '1:1'   },
  web_banner:      { id: 'web_banner',      name: 'Web Banner',      icon: '🌐', LucideIcon: Monitor,      width: 1920, height: 1080, aspectRatio: '16:9'  },
}
